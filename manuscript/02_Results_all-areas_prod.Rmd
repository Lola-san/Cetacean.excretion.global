...
```{r  echo=FALSE, fig.align="center"}
targets::tar_read(fig_all_el_vs_sst_norm)> p1
targets::tar_read(fig_all_el_vs_chloro_norm) -> p2
gridExtra::grid.arrange(p1, p2, ncol = 2)
```
...
```{r  echo=FALSE, fig.align="center"}
targets::tar_read(fig_all_el_vs_sst_fold)> p1
targets::tar_read(fig_all_el_vs_chloro_fold) -> p2
gridExtra::grid.arrange(p1, p2, ncol = 2)
```
