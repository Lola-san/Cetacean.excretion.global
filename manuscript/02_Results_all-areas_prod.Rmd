...
kableExtra::kable(targets::tar_read(tib_models_fold_output), 
                  align = 'c' , 
                  booktabs = TRUE) |>
...
```{r  echo=FALSE, fig.align="center"}
targets::tar_read(graph_models_sst_fold_output) -> p7
targets::tar_read(graph_models_chloro_fold_output) -> p8
