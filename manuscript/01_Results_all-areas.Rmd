...
targets::tar_read(fig_tot_exc_all_areas_facetperel_output)
```

We can visualize better with all elements on one facet, using a log10 transformation on the y scale 

```{r  echo=FALSE, fig.align="center"}
targets::tar_read(fig_tot_exc_all_areas_log10_output)
```
...
```{r  echo=FALSE, fig.align="center"}
targets::tar_read(fig_tot_exc_vs_surfaces_output)
```
...
```{r  echo=FALSE, fig.align="center"}
targets::tar_read(fig_tot_exc_all_areas_facetperel_SD_output)
```
...
```{r  echo=FALSE, fig.align="center"}
targets::tar_read(fig_tot_exc_all_areas_facetperel_DD_output)
```
...
```{r  echo=FALSE, fig.align="center"}
targets::tar_read(fig_tot_exc_all_areas_facetperel_BW_output)
```
