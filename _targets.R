...
list(
  ...
  tar_target(ratio_REMMOA_ANTGUY, 
             compute_ratio_REMMOA_ANTGUY(data_REMMOA_ANTGUY)), 
  ...
  tar_target(abund_Dd_Dc_Sc, 
             build_sp_tib_Dd_Dc_Sc(ratio_full_others)),
  tar_target(abund_BW_sp, 
             build_sp_tib_BW(ratio_full_REMMOAs, ratio_full_others)),
  tar_target(abund_sp_REMMOA_smalldel, 
             build_sp_tib_REMMOA_smalldel(ratio_full_REMMOAs)),
  tar_target(abund_sp_REMMOA_largedel, 
             build_sp_tib_REMMOA_largedel(ratio_full_REMMOAs)),
  tar_target(abund_sp_REMMOA_smallglobi, 
             build_sp_tib_REMMOA_smallglobi(ratio_full_REMMOAs)),
  tar_target(abund_sp_REMMOA_largeglobi, 
             build_sp_tib_REMMOA_largeglobi(ratio_full_REMMOAs)), 
  ...
  tar_target(prey_compo_boot, boot_kernel_inv(prey_compo, 
  ...
  tar_target(sobol_index_all_sensi, 
             create_sobol_index_tib_sensi(model_output, 
                                          nsim = 1e4)), #nsim = 1e4 HERE!
  
  ##############################################################################
  #################### generate outputs (fig + tables) #########################
  ####### refers to functions of 08_base_functions_for_outputs.R ###############
  # format names and order of areas
  tar_target(model_output_clean, format_names(model_output)),
  
  ##############################################################################
  ##### link with productivity - script 09_article_oceano_data_graph.R #########
  ...
  # SCRIPTS 08_base_functions_for_outputs.R
  # 09_generate_outputs_figures_nd_tab.R
  ...
  ####################################################################### TABLES 
  ######################## SUPP DATA 1 - table with statistics for model outputs
  ########## supp data 1a- total nutrient release per area
  # intermediate outputs
  tar_target(tot_est_stat_kg_km2_yr_output, 
             create_full_stat_tab_kg_km2_yr(model_output_clean, 
                                            "output", 
                                            "tot_est_stat_kg_km2_yr")),
  tar_target(tot_est_stat_tns_yr_output, 
             create_full_stat_tab_tons_yr(model_output_clean, 
                                          "output", 
                                          "tot_est_stat_tns_yr")), 
  ...
  # generate file
  tar_target(suppmat1a_areas, 
             supp_table1a_area(list(tot_est_stat_kg_km2_yr_output,
                                    tot_est_stat_tns_yr_output), 
                               table_fold_output,
                               "Supp-mat1a_areas")),
  
  ########## supp data 1b- total nutrient release per habitat
  # intermediate outputs
  tar_target(est_stat_hab_tns_yr_NEA_output, 
             create_hab_stat_tab_tons_yr(model_output_clean,
                                         "output",
                                         "NEA_est_stat_hab_tns_yr",
                                         "Northeast Atlantic")),
  tar_target(est_stat_hab_tns_yr_CNA_output, 
             create_hab_stat_tab_tons_yr(model_output_clean, 
                                         "output",
                                         "CNA_est_stat_hab_tns_yr",
                                         "Central North Atlantic")),
  tar_target(est_stat_hab_tns_yr_NWA_output, 
             create_hab_stat_tab_tons_yr(model_output_clean, 
                                         "output",
                                         "NWA_est_stat_hab_tns_yr",
                                         "Northwest Atlantic")),
  tar_target(est_stat_hab_tns_yr_Med_output, 
             create_hab_stat_tab_tons_yr(model_output_clean,
                                         "output", 
                                         "Med_est_stat_hab_tns_yr",
                                         "Mediterranean Sea")),
  tar_target(est_stat_hab_tns_yr_Ant_output, 
             create_hab_stat_tab_tons_yr(model_output_clean,
                                         "output", 
                                         "Ant_est_stat_hab_tns_yr",
                                         "French Antilles")),
  tar_target(est_stat_hab_tns_yr_Guy_output, 
             create_hab_stat_tab_tons_yr(model_output_clean, 
                                         "output",
                                         "Guy_est_stat_hab_tns_yr",
                                         "French Guyana")),
  tar_target(est_stat_hab_tns_yr_WIO_output, 
             create_hab_stat_tab_tons_yr(model_output_clean,
                                         "output", 
                                         "WIO_est_stat_hab_tns_yr",
                                         "West Indian ocean")),
  tar_target(est_stat_hab_tns_yr_GoAl_output,
             create_hab_stat_tab_tons_yr(model_output_clean, 
                                         "output",
                                         "GoAl_est_stat_hab_tns_yr",
                                         "Gulf of Alaska")),
  tar_target(est_stat_hab_kg_km2_yr_NEA_output, 
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "NEA_est_stat_hab_kg_km2_yr",
                                           "Northeast Atlantic")),
  tar_target(est_stat_hab_kg_km2_yr_CNA_output,
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "CNA_est_stat_hab_kg_km2_yr",
                                           "Central North Atlantic")),
  tar_target(est_stat_hab_kg_km2_yr_NWA_output,
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "NWA_est_stat_hab_kg_km2_yr",
                                           "Northwest Atlantic")),
  tar_target(est_stat_hab_kg_km2_yr_Med_output,
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "Med_est_stat_hab_kg_km2_yr",
                                           "Mediterranean Sea")),
  tar_target(est_stat_hab_kg_km2_yr_Ant_output, 
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "Ant_est_stat_hab_kg_km2_yr",
                                           "French Antilles")),
  tar_target(est_stat_hab_kg_km2_yr_Guy_output, 
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "Guy_est_stat_hab_kg_km2_yr",
                                           "French Guyana")),
  tar_target(est_stat_hab_kg_km2_yr_WIO_output,
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "WIO_est_stat_hab_kg_km2_yr",
                                           "West Indian ocean")),
  tar_target(est_stat_hab_kg_km2_yr_GoAl_output, 
             create_hab_stat_tab_kg_km2_yr(model_output_clean, 
                                           "output",
                                           "GoAl_est_stat_hab_kg_km2_yr",
                                           "Gulf of Alaska")),
  # generate file
  tar_target(suppmat1b_hab, 
             supp_table1b_hab(list_tib_tons = list(est_stat_hab_tns_yr_NEA_output, 
  ...
  ########## supp data 1c- total nutrient release per taxa in each area
  # intermediate outputs
  tar_target(taxa_contrib_tot_NEA_output, 
             taxa_contribution_total(model_output_clean,
                                     "output", 
                                     "NEA_taxa_contrib_tot",
                                     "Northeast Atlantic")), 
  tar_target(taxa_contrib_tot_CNA_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "CNA_taxa_contrib_tot",
                                     "Central North Atlantic")),
  tar_target(taxa_contrib_tot_NWA_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "NWA_taxa_contrib_tot",
                                     "Northwest Atlantic")),
  tar_target(taxa_contrib_tot_Med_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "Med_taxa_contrib_tot",
                                     "Mediterranean Sea")),
  tar_target(taxa_contrib_tot_GoMex_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "GoMex_taxa_contrib_tot",
                                     "Gulf of Mexico")),
  tar_target(taxa_contrib_tot_Ant_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "Ant_taxa_contrib_tot",
                                     "French Antilles")),
  tar_target(taxa_contrib_tot_Guy_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "Guy_taxa_contrib_tot",
                                     "French Guyana")),
  tar_target(taxa_contrib_tot_WIO_output,
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "WIO_taxa_contrib_tot",
                                     "West Indian ocean")),
  tar_target(taxa_contrib_tot_NCal_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "NCal_taxa_contrib_tot",
                                     "New Caledonia")),
  tar_target(taxa_contrib_tot_WFu_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "WFu_taxa_contrib_tot",
                                     "Wallis & Futuna")),
  tar_target(taxa_contrib_tot_FPol_output, 
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "FPol_taxa_contrib_tot",
                                     "French Polynesia")),
  tar_target(taxa_contrib_tot_Haw_output,
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "Haw_taxa_contrib_tot",
                                     "Hawaii")),
  tar_target(taxa_contrib_tot_GoAl_output,
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "GoAl_taxa_contrib_tot",
                                     "Gulf of Alaska")),
  tar_target(taxa_contrib_tot_Calif_output,
             taxa_contribution_total(model_output_clean,
                                     "output",
                                     "Calif_taxa_contrib_tot",
                                     "California current")),
  # generate file
  tar_target(suppmat1c_taxa_areas,
             supp_table1c_taxa_area(list_tib = list(taxa_contrib_tot_NEA_output, 
  ...
  ########## supp data 1d- total nutrient release per taxa in each habitat within areas
  # intermediate outputs
  ...
  tar_target(taxa_contrib_hab_Calif, taxa_contribution_hab(model_output_clean,
                                                           "California current")), 
  # generate file 
  tar_target(suppmat1d_taxa_hab, 
             supp_table1d_taxa_hab(list_tib = list(taxa_contrib_hab_NEA, 
  ...
  ########## supp data 1e- relative composition of waste
  tar_target(suppmat1e_compo_waste, 
             supp_table1e_compo_waste(model_output_clean,  
                                      "Supp-mat1e_compo_waste")),
  
  ########## supp data 1f- statistics for Sobol indices across all species and areas
  tar_target(suppmat1f_Sobol, 
             supp_table1f_sobol(sobol_index_all_sensi,  
                                "Supp-mat1f_Sobol_indices")),
  
  ################################### SUPP DATA 2 - table with statistical tests
  ########## supp data 2a- test of differences between areas
  # intermediate outputs
  tar_target(test_diff_tot_exc_N, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "N")), 
  tar_target(test_diff_tot_exc_P, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "P")),  
  tar_target(test_diff_tot_exc_Fe, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "Fe")),  
  tar_target(test_diff_tot_exc_Cu, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "Cu")),  
  tar_target(test_diff_tot_exc_Mn, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "Mn")),  
  tar_target(test_diff_tot_exc_Se, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "Se")),  
  tar_target(test_diff_tot_exc_Zn, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "Zn")),  
  tar_target(test_diff_tot_exc_Co, 
             create_tab_stat_diff_tot_exc(model_output_clean, 
                                          element = "Co")), 
  # generate file 
  tar_target(suppmat2a_area, 
             supp_table2a_area(list_tib = list(test_diff_tot_exc_N, 
                                               test_diff_tot_exc_P,
  ...
  ########## supp data 2b- test of differences between habitats in areas
  # intermediate outputs
  tar_target(test_diff_hab_NEA_output, 
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "NEA_test_diff_hab",
                                  "Northeast Atlantic")),
  tar_target(test_diff_hab_CNA_output, 
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "CNA_test_diff_hab",
                                  "Central North Atlantic")),
  tar_target(test_diff_hab_NWA_output, 
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "NWA_test_diff_hab",
                                  "Northwest Atlantic")),
  tar_target(test_diff_hab_Med_output, 
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "Med_test_diff_hab",
                                  "Mediterranean Sea")),
  tar_target(test_diff_hab_Ant_output,
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "Ant_test_diff_hab",
                                  "French Antilles")),
  tar_target(test_diff_hab_Guy_output, 
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "Guy_test_diff_hab",
                                  "French Guyana")),
  tar_target(test_diff_hab_WIO_output, 
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "WIO_test_diff_hab",
                                  "West Indian ocean")),
  tar_target(test_diff_hab_GoAl_output, 
             test_differences_hab(model_output_clean,  
                                  "output",
                                  "GoAl_test_diff_hab",
                                  "Gulf of Alaska")),
  # generate file
  tar_target(suppmat2b_hab, 
             supp_table2b_hab(list_tib = list(test_diff_hab_NEA_output, 
  ...
  ########## supp data 2c- test of differences between taxa in each area
  # intermediate outputs 
  tar_target(test_diff_taxa_tot_NEA_output,
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "NEA_test_diff_taxa_tot",
                                   "Northeast Atlantic")),
  tar_target(test_diff_taxa_tot_CNA_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "CNA_test_diff_taxa_tot",
                                   "Central North Atlantic")),
  tar_target(test_diff_taxa_tot_NWA_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "NWA_test_diff_taxa_tot",
                                   "Northwest Atlantic")),
  tar_target(test_diff_taxa_tot_Med_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "Med_test_diff_taxa_tot",
                                   "Mediterranean Sea")),
  tar_target(test_diff_taxa_tot_GoMex_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "GoMex_test_diff_taxa_tot",
                                   "Gulf of Mexico")),
  tar_target(test_diff_taxa_tot_Ant_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "Ant_test_diff_taxa_tot",
                                   "French Antilles")),
  tar_target(test_diff_taxa_tot_Guy_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "Guy_test_diff_taxa_tot",
                                   "French Guyana")),
  tar_target(test_diff_taxa_tot_WIO_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "WIO_test_diff_taxa_tot",
                                   "West Indian ocean")),
  tar_target(test_diff_taxa_tot_NCal_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "NCal_test_diff_taxa_tot",
                                   "New Caledonia")),
  tar_target(test_diff_taxa_tot_WFu_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "WFu_test_diff_taxa_tot",
                                   "Wallis & Futuna")),
  tar_target(test_diff_taxa_tot_FPol_output,
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "FPol_test_diff_taxa_tot",
                                   "French Polynesia")),
  tar_target(test_diff_taxa_tot_Haw_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "Haw_test_diff_taxa_tot",
                                   "Hawaii")),
  tar_target(test_diff_taxa_tot_GoAl_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "GoAl_test_diff_taxa_tot",
                                   "Gulf of Alaska")),
  tar_target(test_diff_taxa_tot_Calif_output, 
             test_differences_taxa(model_output_clean,
                                   "output",
                                   "Calif_test_diff_taxa_tot",
                                   "California current")),
  # generate file
  tar_target(suppmat2c_taxa_area,
             supp_table2c_taxa_area(list_tib = list(test_diff_taxa_tot_NEA_output, 
  ...
  ########## supp data 2d- test of differences between taxa in each habitat within areas
  # intermediate outputs 
  tar_target(test_diff_taxa_hab_NEA, 
             test_differences_taxa_hab(model_output_clean,
                                       "Northeast Atlantic")),
  tar_target(test_diff_taxa_hab_CNA, 
             test_differences_taxa_hab(model_output_clean,
                                       "Central North Atlantic")),
  tar_target(test_diff_taxa_hab_NWA, 
             test_differences_taxa_hab(model_output_clean,
                                       "Northwest Atlantic")),
  tar_target(test_diff_taxa_hab_Med, 
             test_differences_taxa_hab(model_output_clean,
                                       "Mediterranean Sea")),
  tar_target(test_diff_taxa_hab_Ant, 
             test_differences_taxa_hab(model_output_clean,
                                       "French Antilles")),
  tar_target(test_diff_taxa_hab_Guy, 
             test_differences_taxa_hab(model_output_clean,
                                       "French Guyana")),
  tar_target(test_diff_taxa_hab_WIO, 
             test_differences_taxa_hab(model_output_clean,
                                       "West Indian ocean")),
  tar_target(test_diff_taxa_hab_GoAl, 
             test_differences_taxa_hab(model_output_clean,
                                       "Gulf of Alaska")), 
  # generate file
  tar_target(suppmat2d_taxa_hab, 
             supp_table2d_taxa_hab(list_tib = list(test_diff_taxa_hab_NEA, 
                                   ...
                                   "Supp-mat2d_taxa_hab")),
  ########## supp data 2e- test of differences relative composition of waste
  tar_target(suppmat2e_compo_waste, 
             supp_table2e_compo_waste(model_output_clean,  
                                      "Supp-mat2e_compo_waste")), 
  
  ##################### SUPP DATA 3 - table with statistics for model parameters
  tar_target(supp_table3_param_file, 
             supp_table3_param_all_param_sp(model_output_clean,  
                                            paste("Supp-mat3_model_param_stats", 
                                                  nsim = 1e4, sep = "_"))),
  tar_target(supp_table3_param_file_sdcv, 
             supp_table3_param_all_param_sp_with_sdcv(model_output_clean,  
                                                      paste("Supp-mat3_model_param_stats_with_sd_cv", 
                                                            nsim = 1e4, sep = "_"))),
  
  ##################### SUPP DATA 4 - table with model parameters that were 
  # computed from the literature after computation/averaging
  
  # diet description per functional prey groups used as input to calculate mean
  # energy content and nutrient content of each species' diet
  tar_target(supp_table4_diets_file, 
             supp_table_diets(data_diets_PG, 
                              paste("Supp-mat4_model_diets", 
                                    nsim = 1e4, sep = "_"))),
  
  # table with statistics of abundance as calculated from references 
  tar_target(supp_table4_abund, 
             supp_table4_abundances_par(abund_sp_all,
                                        paste("Supp-mat4_model_param_abund", 
                                              nsim = 1e4, sep = "_"))),
  
  ###################################################################### FIGURES 
  # fig. 1 was made in Inkscape software, using raw nutrient release estimates
  # for areas in kg/km2/yr and fold-change ratio, available in supp data 1a
  
  # link with productivity, fig. 2
  tar_target(fig_all_el_vs_chloro_norm_noGuy_file, 
             plot_exc_chloro_all_el_norm(chloro_sst_tib,
                                         model_output_clean, 
                                         guyana = "NO",
                                         "file",
                                         paste("all_exc_all_el_vs_chloro_norm_noGuy", 
                                               nsim = 1e4, 
                                               sep = "_"))),
  tar_target(fig_all_el_vs_sst_norm_file, 
             plot_exc_sst_all_el_norm(chloro_sst_tib,
                                      model_output_clean, 
                                      "file",
  ...
  # nutrient release per unit area in neritic vs oceanic habitats 
  # area per area - intermediate figures for fig. 3, to use in Inkscape
  ...
  # waste products relative composition
  # fig. 4
  tar_target(fig_compo_poop_PCA_biplot, 
             compo_poop_PCA_biplot(model_output_clean,
                                   paste("all_poop_compo_PCA_biplot",
                                         nsim = 1e4,
                                         sep = "_"))),
  # fig. 5
  # intermediate   
  tar_target(tib_full_poop_compo_norm,
             create_tab_full_compo_poop_norm(model_output_clean)),

  tar_target(fig_compo_poop_boxplot, 
             compo_poop_boxplot(tib_full_poop_compo_norm,
                                "file",
  ...
  # area per area - intermediate figures for fig. 6, to use in Inkscape
  ...
  # sensitivity analysis, fig. 7
  tar_target(fig_sensi_all_taxa_all_nut_file, 
             fig_sensitivy_indices_all_taxa_all_nut(sobol_index_all_sensi,
                                                    "file",
                                                    "fig_sensi_all_taxa_all_nut")),
  
  # 'Source data' files for fig 2, 3, 4 & 7
  ...
  tar_target(fig_contrib_taxa_rel_NEA_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            ...
                                            paste("NEA_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_CNA_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_CNA_output,
                                            "Central North Atlantic", 
                                            "file",
                                            paste("CNA_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_NWA_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_NWA_output,
                                            "Northwest Atlantic", 
                                            "file",
                                            paste("NWA_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_Med_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_Med_output,
                                            "Mediterranean Sea", 
                                            "file",
                                            paste("Med_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_GoMex_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_GoMex_output,
                                            "Gulf of Mexico", 
                                            "file",
                                            paste("GoMex_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_Ant_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_Ant_output,
                                            "French Antilles", 
                                            "file",
                                            paste("Ant_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_Guy_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_Guy_output,
                                            "French Guyana", 
                                            "file",
                                            paste("Guy_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_WIO_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_WIO_output,
                                            "West Indian ocean", 
                                            "file",
                                            paste("WIO_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_NCal_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_NCal_output,
                                            "New Caledonia", 
                                            "file",
                                            paste("NCal_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_WFu_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_WFu_output,
                                            "Wallis & Futuna", 
                                            "file",
                                            paste("WFu_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_FPol_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_FPol_output,
                                            "French Polynesia", 
                                            "file",
                                            paste("FPol_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_Haw_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_Haw_output,
                                            "Hawaii", 
                                            "file",
                                            paste("Haw_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_GoAl_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_GoAl_output,
                                            "Gulf of Alaska", 
                                            "file",
                                            paste("GoAl_contrib_taxa", 
                                                  nsim = 1e4, 
                                                  sep = "_"))), 
  tar_target(fig_contrib_taxa_rel_Calif_file, 
             compair_rel_abund_biomass_area(model_output_clean, 
                                            taxa_contrib_tot_Calif_output,
                                            "California current", 
                                            "file",
  ...
  ################## ADDITIONAL MATERIAL #######################################
  ######### tables, figures generated at the first step of result analysis #####
  # all in # to lighten the project of non-used outputs
  
  # ##############################################################################
  # ############################# for all areas - tables #########################
  # # table with estimates and statistics for total excretion in all areas, 
  # # for all elements, in tons/yr
  # tar_target(tot_est_stat_tns_yr_file, 
  #            create_full_stat_tab_tons_yr(model_output_clean, 
  #                                         "file", 
  ...
  # tar_target(tot_est_stat_kg_km2_yr_file, 
  #            create_full_stat_tab_kg_km2_yr(model_output_clean, 
  #                                           "file", 
  #                                           paste("all_est_stat_kg_km2_yr",
  #                                                 nsim = 1e4, 
  #                                                 sep = "_"))),
  # tar_target(tot_est_stat_kg_ha_yr_output, 
  #            create_full_stat_tab_kg_ha_yr(model_output_clean, 
  #                                          "output", 
  ...
  # tar_target(fig_sensi_all_taxa_N_output, 
  #            fig_sensitivy_indices_all_taxa_N(sobol_index_all_sensi,
  #                                             "output",
  #                                             "fig_sensi_all_taxa_N")),
  # tar_target(fig_sensi_all_taxa_N_file, 
  #            fig_sensitivy_indices_all_taxa_N(sobol_index_all_sensi,
  #                                             "file",
  #                                             "fig_sensi_all_taxa_N")),
  # tar_target(fig_sensi_all_taxa_all_nut_output, 
  #            fig_sensitivy_indices_all_taxa_all_nut(sobol_index_all_sensi,
  #                                                   "output",
  #                                                   "fig_sensi_all_taxa_all_nut")),
  # tar_target(fig_sensi_BW_output, 
  #            fig_sensitivy_indices_BW(sobol_index_all_sensi,
  #                                     "output",
  #                                     "fig_sensi_BW")),
  # tar_target(fig_sensi_BW_file, 
  #            fig_sensitivy_indices_BW(sobol_index_all_sensi,
  #                                     "file",
  #                                     "fig_sensi_BW")),
  # tar_target(fig_sensi_DD_output, 
  #            fig_sensitivy_indices_DD(sobol_index_all_sensi,
  #                                     "output",
  #                                     "fig_sensi_DD")),
  # tar_target(fig_sensi_DD_file, 
  #            fig_sensitivy_indices_DD(sobol_index_all_sensi,
  #                                     "file",
  #                                     "fig_sensi_DD")),
  # tar_target(fig_sensi_SD_output, 
  #            fig_sensitivy_indices_SD(sobol_index_all_sensi,
  #                                     "output",
  #                                     "fig_sensi_SD")),
  # tar_target(fig_sensi_SD_file, 
  #            fig_sensitivy_indices_SD(sobol_index_all_sensi,
  #                                     "file",
  #                                     "fig_sensi_SD")),
  # 
  # # nutrient release features for all areas
  # tar_target(fig_tot_exc_all_areas_facetperel_file, 
  #            fig_exc_all_areas_1_facet_element(model_output_clean, 
  #                                              "file",
  #                                              paste("all_fig_tot_exc_facetperel", 
  #                                                    nsim = 1e4, 
  #                                                    sep = "_"))),
  # tar_target(fig_tot_exc_all_areas_facetperel_output, 
  #            fig_exc_all_areas_1_facet_element(model_output_clean, 
  #                                              "output",
  #                                              "all_fig_tot_exc_facetperel")),
  # tar_target(fig_tot_exc_all_areas_log10_file, 
  #            fig_exc_all_areas_log10(model_output_clean, 
  #                                    "file",
  #                                    paste("all_fig_tot_exc_log10", 
  #                                          nsim = 1e4, 
  #                                          sep = "_"))),
  # tar_target(fig_tot_exc_all_areas_log10_output, 
  #            fig_exc_all_areas_log10(model_output_clean, 
  #                                    "output",
  #                                    "all_fig_tot_exc_log10")),
  # tar_target(fig_tot_exc_vs_surfaces_file, 
  #            fig_exc_vs_tot_surf(model_output_clean, 
  #                                "file",
  #                                paste("all_fig_tot_exc_vs_surfaces", 
  #                                      nsim = 1e4, 
  #                                      sep = "_"))),
  # tar_target(fig_tot_exc_vs_surfaces_output, 
  #            fig_exc_vs_tot_surf(model_output_clean, 
  #                                "output",
  #                                "all_fig_tot_exc_vs_surfaces")),
  # tar_target(fig_tot_exc_all_areas_facetperel_BW_file, 
  #            fig_exc_all_areas_1_facet_element_taxa(model_output_clean, 
  #                                                   "Baleen whales",
  #                                                   "file",
  #                                                   paste("all_fig_tot_exc_facetperel_BW", 
  #                                                         nsim = 1e4, 
  #                                                         sep = "_"))),
  # tar_target(fig_tot_exc_all_areas_facetperel_BW_output, 
  #            fig_exc_all_areas_1_facet_element_taxa(model_output_clean, 
  #                                                   "Baleen whales",
  #                                                   "output",
  #                                                   "all_fig_tot_exc_facetperel_BW")),
  # tar_target(fig_tot_exc_all_areas_facetperel_DD_file, 
  #            fig_exc_all_areas_1_facet_element_taxa(model_output_clean,
  #                                                   "Deep divers", 
  #                                                   "file",
  ...
  #                                                         nsim = 1e4, 
  #                                                         sep = "_"))),
  # tar_target(fig_tot_exc_all_areas_facetperel_DD_output, 
  #            fig_exc_all_areas_1_facet_element_taxa(model_output_clean,
  #                                                   "Deep divers", 
  #                                                   "output",
  #                                                   "all_fig_tot_exc_facetperel_DD")),
  # tar_target(fig_tot_exc_all_areas_facetperel_SD_file, 
  #            fig_exc_all_areas_1_facet_element_taxa(model_output_clean, 
  #                                                   "Small delphinids", 
  #                                                   "file",
  ...
  #                                                         nsim = 1e4, 
  #                                                         sep = "_"))),
  # tar_target(fig_tot_exc_all_areas_facetperel_SD_output, 
  #            fig_exc_all_areas_1_facet_element_taxa(model_output_clean, 
  #                                                   "Small delphinids", 
  #                                                   "output",
  ...
  # # generate plots
  # tar_target(fig_N_vs_chloro_Guy_file, 
  #            plot_exc_chloro(chloro_sst_tib,
  #                            model_output_clean,
  #                            "N",
  #                            "YES", 
  #                            "file",
  ...
  #                                  nsim = 1e4, 
  #                                  sep = "_"))),
  # tar_target(fig_N_vs_chloro_Guy_output, 
  #            plot_exc_chloro(chloro_sst_tib,
  #                            model_output_clean,
  #                            "N",
  #                            "YES",
  ...
  # tar_target(fig_N_vs_chloro_noGuy_file, 
  #            plot_exc_chloro(chloro_sst_tib,
  #                            model_output_clean,
  #                            "N",
  #                            "NO", 
  ...
  #                                  nsim = 1e4, 
  #                                  sep = "_"))),
  # tar_target(fig_N_vs_chloro_noGuy_output, 
  #            plot_exc_chloro(chloro_sst_tib,
  #                            model_output_clean,
  #                            "N",
  #                            "NO",
  ...
  # tar_target(fig_all_el_log10_vs_sst_file, 
  #            plot_exc_sst_all_el_log10(chloro_sst_tib,
  #                                      model_output_clean, 
  #                                      "file",
  #                                      paste("all_exc_all_el_log10_vs_sst", 
  #                                            nsim = 1e4, 
  #                                            sep = "_"))),
  # tar_target(fig_all_el_log10_vs_sst_output, 
  #            plot_exc_sst_all_el_log10(chloro_sst_tib,
  #                                      model_output_clean,
  #                                      "output",
  #                                      "all_exc_all_el_log10_vs_sst")),
  # tar_target(fig_all_el_log10_vs_chloro_file, 
  #            plot_exc_chloro_all_el_log10(chloro_sst_tib,
  #                                         model_output_clean, 
  #                                         "file",
  #                                         paste("all_exc_all_el_log10_vs_chloro", 
  #                                               nsim = 1e4, 
  #                                               sep = "_"))),
  # tar_target(fig_all_el_log10_vs_chloro_output, 
  #            plot_exc_chloro_all_el_log10(chloro_sst_tib,
  #                                         model_output_clean,
  #                                         "output",
  #                                         "all_exc_all_el_log10_vs_chloro")),
  # # figure with all elements, one facet no log10 scale
  # tar_target(fig_all_el_vs_sst_file, 
  #            plot_exc_sst_all_el(chloro_sst_tib,
  #                                model_output_clean, 
  #                                "file",
  #                                paste("all_exc_all_el_vs_sst", 
  #                                      nsim = 1e4, 
  #                                      sep = "_"))),
  # tar_target(fig_all_el_vs_sst_output, 
  #            plot_exc_sst_all_el(chloro_sst_tib,
  #                                model_output_clean,
  #                                "output",
  #                                "all_exc_all_el_vs_sst")),
  # tar_target(fig_all_el_vs_chloro_file, 
  #            plot_exc_chloro_all_el(chloro_sst_tib,
  #                                   model_output_clean, 
  #                                   "file",
  #                                   paste("all_exc_all_el_vs_chloro", 
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_all_el_vs_chloro_output, 
  #            plot_exc_chloro_all_el(chloro_sst_tib,
  #                                   model_output_clean,
  #                                   "output",
  #                                   "all_exc_all_el_vs_chloro")),
  # # figure with all elements, one facet no log10 scale but normalized excretion
  # tar_target(fig_all_el_vs_sst_norm_output, 
  #            plot_exc_sst_all_el_norm(chloro_sst_tib,
  #                                     model_output_clean,
  #                                     "output",
  #                                     "all_exc_all_el_vs_sst_norm")),
  # tar_target(fig_all_el_vs_chloro_norm_file, 
  #            plot_exc_chloro_all_el_norm(chloro_sst_tib,
  #                                        model_output_clean, 
  #                                        guyana = "YES",
  #                                        "file",
  ...
  #                                              nsim = 1e4, 
  #                                              sep = "_"))),
  # tar_target(fig_all_el_vs_chloro_norm_output,
  #            plot_exc_chloro_all_el_norm(chloro_sst_tib,
  #                                        model_output_clean,
  #                                        guyana = "YES",
  #                                        "output",
  #                                        "all_exc_all_el_vs_chloro_norm")),
  # tar_target(fig_all_el_vs_chloro_norm_noGuy_output,
  #            plot_exc_chloro_all_el_norm(chloro_sst_tib,
  #                                        model_output_clean,
  #                                        guyana = "NO",
  #                                        "output",
  ...
  # tar_target(graph_models_sst_norm_file, 
  #            graph_models_sst(tib_models_norm_output, 
  #                             "file",
  #                             paste("all_graph_models_sst_norm", 
  #                                   nsim = 1e4, 
  #                                   sep = "_"))),
  # tar_target(graph_models_sst_norm_output, 
  #            graph_models_sst(tib_models_norm_output,
  #                             "output",
  #                             "all_graph_models_sst_norm")),
  # tar_target(graph_models_chloro_norm_file,
  #            graph_models_chloro(tib_models_norm_output, 
  #                                "file",
  #                                paste("all_graph_models_chloro_norm", 
  #                                      nsim = 1e4, 
  #                                      sep = "_"))),
  # tar_target(graph_models_chloro_norm_output,
  #            graph_models_chloro(tib_models_norm_output,
  #                                "output",
  #                                "all_graph_models_chloro_norm")),
  # 
  # ### for all areas ##### waste products composition
  # tar_target(tib_poop_compo_file, 
  #            create_stat_tab_compo_poop(model_output_clean, 
  #                                       "file",
  #                                       paste("all_tib_poop_compo", 
  #                                             nsim = 1e4, 
  #                                             sep = "_"))),
  # tar_target(tib_poop_compo_output, 
  #            create_stat_tab_compo_poop(model_output_clean,
  #                                       "output",
  #                                       "all_tib_poop_compo")),
  # tar_target(tib_poop_compo_norm_file, 
  #            create_stat_tab_compo_poop_norm(model_output_clean, 
  #                                            "file",
  #                                            paste("all_tib_poop_compo_norm", 
  #                                                  nsim = 1e4, 
  #                                                  sep = "_"))),
  # tar_target(tib_poop_compo_norm_output, 
  #            create_stat_tab_compo_poop_norm(model_output_clean,
  #                                            "output",
  #                                            "all_tib_poop_compo_norm")),
  # tar_target(tib_test_diff_poop_compo_file, 
  #            test_differences_compo_poop(model_output_clean, 
  #                                        "file",
  #                                        paste("all_tib_test_diff_poop_compo", 
  #                                              nsim = 1e4, 
  #                                              sep = "_"))),
  # tar_target(tib_test_diff_poop_compo_output, 
  #            test_differences_compo_poop(model_output_clean,
  #                                        "output",
  ...
  # # tons/yr
  # tar_target(est_stat_hab_tns_yr_NEA_file, 
  #            create_hab_stat_tab_tons_yr(model_output_clean,
  #                                        "file",
  ...
  #                                              sep = "_"),
  #                                        "Northeast Atlantic")),
  # tar_target(est_stat_hab_tns_yr_CNA_file, 
  #            create_hab_stat_tab_tons_yr(model_output_clean, 
  #                                        "file",
  ...
  #                                              sep = "_"),
  #                                        "Central North Atlantic")),
  # tar_target(est_stat_hab_tns_yr_NWA_file,
  #            create_hab_stat_tab_tons_yr(model_output_clean, 
  #                                        "file",
  ...
  #                                              sep = "_"),
  #                                        "Northwest Atlantic")),
  # tar_target(est_stat_hab_tns_yr_Med_file, 
  #            create_hab_stat_tab_tons_yr(model_output_clean,
  #                                        "file", 
  ...
  #                                              sep = "_"),
  #                                        "Mediterranean Sea")),
  # tar_target(est_stat_hab_tns_yr_Ant_file, 
  #            create_hab_stat_tab_tons_yr(model_output_clean,
  #                                        "file", 
  ...
  #                                              sep = "_"),
  #                                        "French Antilles")),
  # tar_target(est_stat_hab_tns_yr_Guy_file, 
  #            create_hab_stat_tab_tons_yr(model_output_clean, 
  #                                        "file",
  ...
  #                                              sep = "_"),
  #                                        "French Guyana")),
  # tar_target(est_stat_hab_tns_yr_WIO_file,
  #            create_hab_stat_tab_tons_yr(model_output_clean,
  #                                        "file", 
  ...
  #                                              sep = "_"),
  #                                        "West Indian ocean")),
  # tar_target(est_stat_hab_tns_yr_GoAl_file, 
  #            create_hab_stat_tab_tons_yr(model_output_clean, 
  #                                        "file",
  ...
  # # table with estimates and statistics for habitats - just for 8 of the areas with 2 habitats
  # # kg/km2/yr
  # tar_target(est_stat_hab_kg_km2_yr_NEA_file, 
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  #                                                sep = "_"),
  #                                          "Northeast Atlantic")),
  # tar_target(est_stat_hab_kg_km2_yr_CNA_file, 
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  #                                                sep = "_"),
  #                                          "Central North Atlantic")),
  # tar_target(est_stat_hab_kg_km2_yr_NWA_file,
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  #                                                sep = "_"),
  #                                          "Northwest Atlantic")),
  # tar_target(est_stat_hab_kg_km2_yr_Med_file,
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  #                                                sep = "_"),
  #                                          "Mediterranean Sea")),
  # tar_target(est_stat_hab_kg_km2_yr_Ant_file, 
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  #                                                sep = "_"),
  #                                          "French Antilles")),
  # tar_target(est_stat_hab_kg_km2_yr_Guy_file, 
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  #                                                sep = "_"),
  #                                          "French Guyana")),
  # tar_target(est_stat_hab_kg_km2_yr_WIO_file,
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  #                                                sep = "_"),
  #                                          "West Indian ocean")),
  # tar_target(est_stat_hab_kg_km2_yr_GoAl_file, 
  #            create_hab_stat_tab_kg_km2_yr(model_output_clean, 
  #                                          "file",
  ...
  # tar_target(test_diff_hab_NEA_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  #                                       sep = "_"),
  #                                 "Northeast Atlantic")),
  # tar_target(test_diff_hab_CNA_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  #                                       sep = "_"),
  #                                 "Central North Atlantic")),
  # tar_target(test_diff_hab_NWA_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  #                                       sep = "_"),
  #                                 "Northwest Atlantic")),
  # tar_target(test_diff_hab_Med_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  #                                       sep = "_"),
  #                                 "Mediterranean Sea")),
  # tar_target(test_diff_hab_Ant_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  #                                       sep = "_"),
  #                                 "French Antilles")),
  # tar_target(test_diff_hab_Guy_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  #                                       sep = "_"),
  #                                 "French Guyana")),
  # tar_target(test_diff_hab_WIO_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  #                                       sep = "_"),
  #                                 "West Indian ocean")),
  # tar_target(test_diff_hab_GoAl_file, 
  #            test_differences_hab(model_output_clean,  
  #                                 "file",
  ...
  # tar_target(taxa_contrib_tot_NEA_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file", 
  ...
  #                                          sep = "_"),
  #                                    "Northeast Atlantic")),
  # tar_target(taxa_contrib_tot_CNA_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "Central North Atlantic")), 
  # tar_target(taxa_contrib_tot_NWA_file,
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "Northwest Atlantic")),
  # tar_target(taxa_contrib_tot_Med_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "Mediterranean Sea")),
  # tar_target(taxa_contrib_tot_GoMex_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "Gulf of Mexico")),
  # tar_target(taxa_contrib_tot_Ant_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "French Antilles")),
  # tar_target(taxa_contrib_tot_Guy_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "French Guyana")),
  # tar_target(taxa_contrib_tot_WIO_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "West Indian ocean")),
  # tar_target(taxa_contrib_tot_NCal_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "New Caledonia")),
  # tar_target(taxa_contrib_tot_WFu_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "Wallis & Futuna")),
  # tar_target(taxa_contrib_tot_FPol_file, 
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "French Polynesia")),
  # tar_target(taxa_contrib_tot_Haw_file,
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "Hawaii")),
  # tar_target(taxa_contrib_tot_GoAl_file,
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  #                                          sep = "_"),
  #                                    "Gulf of Alaska")),
  # tar_target(taxa_contrib_tot_Calif_file,
  #            taxa_contribution_total(model_output_clean,
  #                                    "file",
  ...
  # tar_target(test_diff_taxa_tot_NEA_file,
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Northeast Atlantic")),
  # tar_target(test_diff_taxa_tot_CNA_file,
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Central North Atlantic")),
  # tar_target(test_diff_taxa_tot_NWA_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Northwest Atlantic")),
  # tar_target(test_diff_taxa_tot_Med_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Mediterranean Sea")),
  # tar_target(test_diff_taxa_tot_GoMex_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Gulf of Mexico")),
  # tar_target(test_diff_taxa_tot_Ant_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "French Antilles")),
  # tar_target(test_diff_taxa_tot_Guy_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "French Guyana")),
  # tar_target(test_diff_taxa_tot_WIO_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "West Indian ocean")),
  # tar_target(test_diff_taxa_tot_NCal_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "New Caledonia")),
  # tar_target(test_diff_taxa_tot_WFu_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Wallis & Futuna")),
  # tar_target(test_diff_taxa_tot_FPol_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "French Polynesia")),
  # tar_target(test_diff_taxa_tot_Haw_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Hawaii")),
  # tar_target(test_diff_taxa_tot_GoAl_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  #                                        sep = "_"),
  #                                  "Gulf of Alaska")),
  # tar_target(test_diff_taxa_tot_Calif_file, 
  #            test_differences_taxa(model_output_clean,
  #                                  "file",
  ...
  # tar_target(fig_contrib_taxa_NEA_file, 
  #            fig_exc_taxa_log10(model_output_clean, 
  #                               "Northeast Atlantic", 
  #                               "file",
  #                               paste("NEA_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_NEA_output, 
  #            fig_exc_taxa_log10(model_output_clean, 
  #                               "Northeast Atlantic", 
  #                               "output",
  #                               "NEA_contrib_taxa")),
  # tar_target(fig_contrib_taxa_CNA_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Central North Atlantic", 
  #                               "file",
  #                               paste("CNA_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_CNA_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Central North Atlantic", 
  #                               "output",
  #                               "CNA_contrib_taxa")),
  # tar_target(fig_contrib_taxa_NWA_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Northwest Atlantic", 
  #                               "file",
  #                               paste("NWA_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_NWA_output,
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Northwest Atlantic", 
  #                               "output",
  #                               "NWA_contrib_taxa")),
  # tar_target(fig_contrib_taxa_Med_file,
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Mediterranean Sea", 
  #                               "file",
  #                               paste("Med_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_Med_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Mediterranean Sea", 
  #                               "output",
  #                               "Med_contrib_taxa")),
  # tar_target(fig_contrib_taxa_GoMex_file,
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Gulf of Mexico", 
  #                               "file",
  #                               paste("GoMex_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_GoMex_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Gulf of Mexico", 
  #                               "output",
  #                               "GoMex_contrib_taxa")),
  # tar_target(fig_contrib_taxa_Ant_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "French Antilles", 
  #                               "file",
  #                               paste("Ant_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_Ant_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "French Antilles", 
  #                               "output",
  #                               "Ant_contrib_taxa")),
  # tar_target(fig_contrib_taxa_Guy_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "French Guyana", 
  #                               "file",
  #                               paste("Guy_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_Guy_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "French Guyana",
  #                               "output", 
  #                               "Guy_contrib_taxa")),
  # tar_target(fig_contrib_taxa_WIO_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "West Indian ocean", 
  #                               "file",
  #                               paste("WIO_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_WIO_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "West Indian ocean", 
  #                               "output",
  #                               "WIO_contrib_taxa")),
  # tar_target(fig_contrib_taxa_NCal_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "New Caledonia", 
  #                               "file",
  #                               paste("NCal_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_NCal_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "New Caledonia", 
  #                               "output",
  #                               "NCal_contrib_taxa")),
  # tar_target(fig_contrib_taxa_WFu_file,
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Wallis & Futuna", 
  #                               "file",
  #                               paste("WFu_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_WFu_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Wallis & Futuna", 
  #                               "output",
  #                               "WFu_contrib_taxa")),
  # tar_target(fig_contrib_taxa_FPol_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "French Polynesia", 
  #                               "file",
  #                               paste("FPol_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_FPol_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "French Polynesia", 
  #                               "output",
  #                               "FPol_contrib_taxa")),
  # tar_target(fig_contrib_taxa_Haw_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Hawaii", 
  #                               "file",
  #                               paste("Haw_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_Haw_output,
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Hawaii", 
  #                               "output",
  #                               "Haw_contrib_taxa")),
  # tar_target(fig_contrib_taxa_GoAl_file,
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Gulf of Alaska", 
  #                               "file",
  #                               paste("GoAl_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_GoAl_output,
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "Gulf of Alaska", 
  #                               "output",
  #                               "GoAl_contrib_taxa")),
  # tar_target(fig_contrib_taxa_Calif_file, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "California current", 
  #                               "file",
  #                               paste("Calif_contrib_taxa", 
  #                                     nsim = 1e4, 
  #                                     sep = "_"))),
  # tar_target(fig_contrib_taxa_Calif_output, 
  #            fig_exc_taxa_log10(model_output_clean,
  #                               "California current", 
  #                               "output",
  #                               "Calif_contrib_taxa")),
  ...
  # tar_target(fig_hab_abs_NEA_file,
  #            fig_exc_hab_log10(model_output_clean, 
  #                              "Northeast Atlantic", 
  #                              "weight", 
  #                              "file",
  ...
  #                                    nsim = 1e4, 
  #                                    sep = "_"))),
  # tar_target(fig_hab_abs_NEA_output, 
  #            fig_exc_hab_log10(model_output_clean, 
  #                              "Northeast Atlantic", 
  #                              "weight", 
  #                              "output",
  #                              "NEA_exc_hab_abs")),
  # tar_target(fig_hab_abs_CNA_file, 
  #            fig_exc_hab_log10(model_output_clean,
  #                              "Central North Atlantic",
  #                              "weight", 
  #                              "file",
  ...
  # tar_target(fig_hab_taxa_NEA_file, 
  #            fig_exc_hab_taxa_log10(model_output_clean, 
  #                                   "Northeast Atlantic", 
  #                                   "file",
  #                                   paste("NEA_exc_hab_taxa", 
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_hab_taxa_NEA_output, 
  #            fig_exc_hab_taxa_log10(model_output_clean, 
  #                                   "Northeast Atlantic", 
  #                                   "output",
  #                                   "NEA_exc_hab_taxa")),
  # tar_target(fig_hab_taxa_CNA_file, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Central North Atlantic", 
  #                                   "file",
  ...
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_hab_taxa_CNA_output,
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Central North Atlantic", 
  #                                   "output",
  #                                   "CNA_exc_hab_taxa")),
  # tar_target(fig_hab_taxa_NWA_file, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Northwest Atlantic", 
  #                                   "file",
  ...
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_hab_taxa_NWA_output, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Northwest Atlantic", 
  #                                   "output",
  #                                   "NWA_exc_hab_taxa")),
  # tar_target(fig_hab_taxa_Med_file, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Mediterranean Sea", 
  #                                   "file",
  ...
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_hab_taxa_Med_output,
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Mediterranean Sea", 
  #                                   "output",
  #                                   "Med_exc_hab_taxa")),
  # tar_target(fig_hab_taxa_Ant_file, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "French Antilles", 
  #                                   "file",
  ...
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_hab_taxa_Ant_output, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "French Antilles", 
  #                                   "output",
  #                                   "Ant_exc_hab_taxa")),
  # tar_target(fig_hab_taxa_Guy_file, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "French Guyana", 
  #                                   "file",
  ...
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_hab_taxa_Guy_output, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "French Guyana", 
  #                                   "output",
  #                                   "Guy_exc_hab_taxa")),
  # tar_target(fig_hab_taxa_WIO_file, 
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "West Indian ocean", 
  #                                   "file",
  ...
  #                                         nsim = 1e4, 
  #                                         sep = "_"))),
  # tar_target(fig_hab_taxa_WIO_output,
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "West Indian ocean", 
  #                                   "output",
  #                                   "WIO_exc_hab_taxa")),
  # tar_target(fig_hab_taxa_GoAl_file,
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Gulf of Alaska", 
  #                                   "file",
  ...
  #                                         nsim = 1e4, 
  #                                         sep = "_"))), 
  # tar_target(fig_hab_taxa_GoAl_output,
  #            fig_exc_hab_taxa_log10(model_output_clean,
  #                                   "Gulf of Alaska", 
  #                                   "output",
  #                                   "GoAl_exc_hab_taxa")), 
  # 
  #################### carbon in biomass #####################
  tar_target(tab_C_in_biomass, 
             create_tab_C_in_bio(model_output_clean,
                                                   "file",
                                                   "stats_C_in_biomass")),
  tar_target(fig_C_in_biomass_areas_tns,
             create_fig_C_per_area_tons(model_output_clean,
                                        "fig_C_in_biomass_tns")),
  tar_target(fig_C_in_biomass_areas_tns_per_km2,
             create_fig_C_per_area_tons_per_km2(model_output_clean,
                                                "fig_C_in_biomass_tns_per_km2")),
  tar_target(fig_C_in_biomass_areas_tns_eco_gps_tot,
             create_fig_C_per_taxa_tot(model_output_clean,
                                       "fig_C_in_biomass_tns_gps")),
  tar_target(fig_C_in_biomass_areas_tns_eco_gps_areas,
             create_fig_C_per_taxa_per_area(model_output_clean,
  ...
  tar_target(abund_Bala_phy_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Bala_phy, 
                                 "Balaenoptera physalus", 
                                 "Bala_phy")),
  tar_target(abund_Bala_acu_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Bala_acu, 
                                 "Balaenoptera acutorostrata", 
                                 "Bala_acu")),
  tar_target(abund_Bala_mus_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Bala_mus, 
                                 "Balaenoptera musculus", 
                                 "Bala_mus")),
  tar_target(abund_Bala_bor_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Bala_bor, 
                                 "Balaenoptera borealis", 
                                 "Bala_bor")),
  tar_target(abund_Mega_nov_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Mega_nov, 
                                 "Megaptera novaeangliae", 
                                 "Mega_nov")),
  tar_target(abund_Glob_mel_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Glob_mel, 
                                 "Globicephala melas", 
                                 "Glob_mel")),
  tar_target(abund_Gram_gri_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Gram_gri, 
                                 "Grampus griseus", 
                                 "Gram_gri")),
  tar_target(abund_Phys_mac_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Phys_mac, 
                                 "Physeter macrocephalus", 
                                 "Phys_mac")),
  tar_target(abund_Lage_alb_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Lage_alb, 
                                 "Lagenorhynchus albirostris", 
                                 "Lage_alb")),
  tar_target(abund_Lage_acu_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Lage_acu, 
                                 "Lagenorhynchus acutus", 
                                 "Lage_acu")),
  tar_target(abund_Turs_tru_SUMMER, 
             build_sp_tib_SUMMER(original_tib_Turs_tru, 
                                 "Tursiops truncatus", 
                                 "Turs_tru")),
  ...
  tar_target(ratio_full_SUMMER, bind_ratio_SUMMER(ratio_NEA, 
                                                  ratio_ASI_SUMMER)), 
  tar_target(abund_Dd_Dc_Sc_SUMMER, 
             build_sp_tib_Dd_Dc_Sc_SUMMER(ratio_full_SUMMER)),
  ...
  tar_target(abund_sp_all_SUMMER, rbind(abund_Bala_phy_SUMMER,
                                        abund_Bala_acu_SUMMER,
                                        abund_Bala_mus_SUMMER,
                                        abund_Bala_bor_SUMMER,
                                        abund_Mega_nov_SUMMER,
                                        abund_Glob_mel_SUMMER, 
                                        abund_Gram_gri_SUMMER, 
                                        abund_Phys_mac_SUMMER,
                                        abund_Lage_alb_SUMMER,
                                        abund_Lage_acu_SUMMER,
  ...
  # needs output
  # in KJ 
  tar_target(table_SUMMER_sp_needs, 
             SUMMER_table_needs_sp(model_output_clean_SUMMER)),
  tar_target(fig_SUMMER_sp_needs, 
             SUMMER_barplot_needs_sp(model_output_clean_SUMMER)),
  tar_target(fig_SUMMER_gp_needs, 
             SUMMER_barplot_needs_gp(model_output_clean_SUMMER)),
