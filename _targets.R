...
list(
  ...
  tar_target(abund_Bala_phy_SUMMER, build_sp_tib_SUMMER(original_tib_Bala_phy, 
                                                        "Balaenoptera physalus", 
                                                        "Bala_phy")),
  tar_target(abund_Bala_acu_SUMMER, build_sp_tib_SUMMER(original_tib_Bala_acu, 
                                                        "Balaenoptera acutorostrata", 
                                                        "Bala_acu")),
  tar_target(abund_Bala_mus_SUMMER, build_sp_tib_SUMMER(original_tib_Bala_mus, 
                                                        "Balaenoptera musculus", 
                                                        "Bala_mus")),
  tar_target(abund_Bala_bor_SUMMER, build_sp_tib_SUMMER(original_tib_Bala_bor, 
                                                        "Balaenoptera borealis", 
                                                        "Bala_bor")),
  tar_target(abund_Mega_nov_SUMMER, build_sp_tib_SUMMER(original_tib_Mega_nov, 
                                                        "Megaptera novaeangliae", 
                                                        "Mega_nov")),
  ...
  tar_target(abund_Phys_mac_SUMMER, build_sp_tib_SUMMER(original_tib_Phys_mac, 
                                                        "Physeter macrocephalus", 
                                                        "Phys_mac")),
  tar_target(abund_Lage_alb_SUMMER, build_sp_tib_SUMMER(original_tib_Lage_alb, 
                                                        "Lagenorhynchus albirostris", 
                                                        "Lage_alb")),
  tar_target(abund_Lage_acu_SUMMER, build_sp_tib_SUMMER(original_tib_Lage_acu, 
                                                        "Lagenorhynchus acutus", 
                                                        "Lage_acu")),
